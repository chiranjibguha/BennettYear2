...
public class Homepage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText custom = findViewById(R.id.editTextTextMultiLine);
        ...
        sett.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent1();
                sett.setBackgroundColor(170);
                screen.setBackgroundColor(270);
                ads.setBackgroundColor(270);
        ...
        screen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent2();
                screen.setBackgroundColor(170);
                ads.setBackgroundColor(270);
                sett.setBackgroundColor(270);
            }
        });
    ...
    void paster()
    {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            Notification notification = new NotificationCompat.Builder(this, id)
                    ...
                    .setContentText("Give Rest to Your eyes. Its been long....")
                    .build();
